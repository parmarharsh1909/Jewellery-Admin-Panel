...
export default function EditMainCategories() {
  const { id } = useParams();
    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          <p className="text-gray-500">Main category not found</p>
          <button
            onClick={() => navigate('/categories/main/manage')}
            className="mt-4 btn-primary"
          >
            Back to Manage Main Categories
          </button>
        </div>
      </div>
    );
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        >
          <ArrowLeft size={20} />
          <span>Back to Manage Main Categories</span>
        </button>
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Edit Main Category</h1>
            <p className="text-gray-600 mt-1">Update main category information</p>
          </div>
        </div>
      </div>
