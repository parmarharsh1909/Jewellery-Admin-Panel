...
alert(CatName+""+CatDescription+""+MainCatId);
    ...
    axios.post("http://localhost/Jewellerydb/addSubCategory.php",formdata).then((Response)=>{
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="card max-w-3xl">
          ...
          <div className="flex gap-4 pt-4">
            <button type="submit" className="btn-primary px-6 py-2" onClick={addSubCategory}>
              Submit
            </button>
            <button
              type="button"
