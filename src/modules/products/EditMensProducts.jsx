...
const EditMensProducts = () => {
  ...
  useEffect(() => {
    ...
    axios
      .post("http://localhost/Jewellerydb/getMenProduct.php", formData)
      .then((res) => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold">Edit Men's Product</h1>
      </div>
...
export default EditMensProducts;
