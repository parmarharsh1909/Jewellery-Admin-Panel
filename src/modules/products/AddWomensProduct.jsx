  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold">Add Women's Product</h1>
      </div>
      ...
      <div className="bg-white rounded-xl shadow p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <select ref={subCatRef} className="input-field text-gray-700">
          ...
          <div>
            ...
            {imagePreview ? (
              ...
              <label className="flex flex-col items-center justify-center h-56 border-2 border-dashed rounded-lg cursor-pointer hover:border-pink-500">
