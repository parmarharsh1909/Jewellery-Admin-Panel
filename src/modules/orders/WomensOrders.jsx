...
const initialOrders = [
  {
    ...
    products: [
      { name: 'Diamond Ring', quantity: 1, price: 45000 }
    ],
    total: 45000,
    status: 'Completed',
    paymentStatus: 'Paid',
  ...
  },
  {
    ...
    products: [
      { name: 'Pearl Earrings', quantity: 1, price: 18500 }
    ],
    total: 18500,
    status: 'Pending',
  ...
  },
  {
    ...
    products: [
      { name: 'Diamond Pendant', quantity: 1, price: 35000 }
    ],
    total: 35000,
    status: 'Processing',
    paymentStatus: 'Paid',
    date: '2024-12-01',
    shippingAddress: '303 Jubilee Hills, Hyderabad, Telangana 500033'
  },
];

export default function WomensOrders() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Women's Orders</h1>
        <p className="text-gray-600 mt-1">Manage women's product orders</p>
      </div>
      ...
      <div className="card overflow-hidden">
        ...
        {filteredOrders.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No women's orders found</h3>
